function format(diff: number, divisor: number, unit: string, past: string, future: string, isInTheFuture: boolean): string {
...
export function TimeDuration(date: Date | string): string {
